...
5. Run the reviewer  
    ...
    b. __macOS__: Hold the 'control' key and click the `reviewer.command` file, then click 'Open' in the menu to run the resume reviewer. When you want to run the reviewer, this is the only file you will have to run.
